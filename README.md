...
- [09/22, 2022] Our work is accepted to [NeurIPS 2022](https://nips.cc/Conferences/2022).
- [11/2022] Our work is now included at [Paper with Code](https://paperswithcode.com/dataset/scienceqa).
- [11/20, 2022] Our work is covered by [Geek Culture | Medium](https://medium.com/geekculture/neurips-2022-the-first-multi-modal-science-question-answering-science-qa-dataset-with-detailed-45b8d628b301).
- [11/29, 2022] Our work gives an poster presentation by Pan Lu at [NeurIPS 2022](https://nips.cc/Conferences/2022).
- [02/02, 2023] The ScienceQA dataset has served as the primary benchmark for the new generation of multimodal reasoning systems, [Multimodal-CoT](https://github.com/amazon-science/mm-cot), developed by [Amazon Science](https://www.amazon.science/).
- [02/24, 2023] The ScienceQA dataset is now included at [HuggingFace Datasets](https://huggingface.co/datasets/derek-thomas/ScienceQA).
- [02/05, 2023] Our work is covered by [MarkTechPost](https://www.marktechpost.com/2023/02/05/a-new-artificial-intelligence-research-proposes-multimodal-chain-of-thought-reasoning-in-language-models-that-outperforms-gpt-3-5-by-16-75-17-%E2%86%92-91-68-on-scienceqa/).
- [02/13, 2023] Our work gives an oral presentation by Pan Lu at [AAAI 2023 KnowledgeNLP Workshop](https://knowledge-nlp.github.io/aaai2023/publications.html).
- [03/28, 2023] The ScienceQA dataset has served as the primary benchmark for [LLaMA-Adapter](https://github.com/ZrrSkywalker/LLaMA-Adapter), developed by Shanghai AI Laboratory, UCLA, and CUHK.
- [03/30, 2023] The ScienceQA dataset is now included at [OpenDataLab](https://opendatalab.org.cn/ScienceQA).
- [04/01, 2023] Our ScienceQA dataset was downloaded 377 times in March at [HuggingFace Datasets](https://huggingface.co/datasets/derek-thomas/ScienceQA).
